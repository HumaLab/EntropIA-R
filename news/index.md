...
- Bug fixes: malformed JSON cells carrying bytes that are not valid
  ...
  [`entropia_collect()`](https://github.com/HumaLab/EntropIA-R/reference/entropia_collect.md)/[`entropia_metadata()`](https://github.com/HumaLab/EntropIA-R/reference/entropia_metadata.md)
