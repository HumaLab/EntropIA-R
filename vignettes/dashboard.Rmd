---
title: "Dashboard local e informes congelados"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Dashboard local e informes congelados}
...
*Versión en español.* English: `vignette("dashboard.en")`.

El dashboard y el informe Quarto **reutilizan** las tablas de
`entropia_overview()`. No hay un segundo juego de métricas.
...
Apuntá la app a un **snapshot autocontenido**. Un `-wal` no vacío se rechaza:
no es un visor en vivo de la app de escritorio.
...
**Aplicar filtros** fija el universo. Las colecciones se eligen por ID. Fuente
/ modelo / confianza de entidades afectan solo las tablas de entidades.
...
- El perfil de longitudes son las primeras N filas en orden estable, no una
  muestra aleatoria.

Siguiente: `vignette("administration")`. English: `vignette("dashboard.en")`.
